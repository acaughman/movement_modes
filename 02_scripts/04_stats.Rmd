...
# get effect size 
temp_data %>% kruskal_effsize(temp_preferred ~ class2)
...
# get effect size 
longevity_data %>% kruskal_effsize(longevity_wild ~ class2)
...
# get effect size 
filled_data2 %>% kruskal_effsize(diet_troph3 ~ class2)
