...
trait_summary2 <- filled_data2 %>% 
  dplyr::select(class2, r_fin, temp_range, oxygen_cons, sp_richness, fecundity_mean) %>% 
  group_by(class2) %>% 
  summarise(across(where(is.numeric), 
                   list(
                     mean = ~mean(., na.rm = TRUE), 
...
# get effect size 
filled_data2 %>% kruskal_effsize(r_fin ~ class2, ci = TRUE)
...
# get effect size 
filled_data2 %>% kruskal_effsize(temp_range ~ class2, ci = TRUE)
...
# get effect size 
filled_data2 %>% kruskal_effsize(oxygen_cons ~ class2, ci = TRUE)
...
# get effect size 
filled_data2 %>% kruskal_effsize(sp_richness ~ class2, ci = TRUE)
# eta2 = 0.0385, SMALL effect
