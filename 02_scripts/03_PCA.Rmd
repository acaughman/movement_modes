...
f1_fig <- fviz_famd_ind(f1, label = "none", habillage = famd_1$class2, palette = hcl.colors(6, "viridis"), addEllipses = FALSE, ellipse.level = 0.95, invisible = "quali.var", alpha.ind = 0.3, ellipse.alpha = 0.2) +
  theme_bw(base_size = 16) +
