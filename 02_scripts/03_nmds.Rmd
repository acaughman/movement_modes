...
f1_fig <- fviz_famd_ind(f1, label = "none", habillage = famd_1$class2, palette = hcl.colors(6, "viridis"), 
                        ...
                        ellipse.alpha = 0.2) +
  theme_bw(base_size = 16) +
  labs(x = "FAMD1 (13.4%)", y = "FAMD2 (9.9%)", color = "Movement Group (Homerange/PLD)", 
       fill = "Movement Group (Homerange/PLD)", title = NULL) +
  scale_y_continuous(position = "right") +
...
nmds_1 <- ggplot(filled_scores, aes(x = NMDS1, y = NMDS2)) +
  ...
  labs(x = "nMDS1", y = "nMDS2", color = "Movement Group (Homerange/PLD)") +
...
ggsave(nmds_2, file = paste0("fig2.pdf"), path = here::here("03_figs"), height = 8, width = 15)
