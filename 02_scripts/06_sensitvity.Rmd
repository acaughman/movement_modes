...
```{r}
lm1 <- lm(log(home_range) ~ length * r_fin * longevity_wild * temp_preferred, data = filled_data_save %>% filter(!is.na(home_range)))
...
Optimal_Temp <- c(0.156, 0.073, 0.0062, 0.4705, 0.0323, 
              ...
              0.00339, 0.00028, 
              0.1562)
temp_arrows <- c("decrease", "decrease", "decrease", "increase", "increase", 
...
Length <- c(0.614, 0.998, 0.209, 0.000006, 0.0000003, 
              ...
              0.759, 0.0894, 
              0.522)
length_arrows <- c("increase", "decrease", "increase", "increase", "increase", 
...
Lifespan <- c(0.75, 0.322, 0.5404, 0.615, 0.666, 
              ...
              0.5999, 0.5100, 
              0.478)
life_arrows <- c("increase", "increase", "increase", "increase", "decrease", 
...
Growth_Rate <- c(0.342, 0.0119, 0.359, 0.319, 0.402, 
              ...
              0.822, 0.922, 
              0.868)
growth_arrows <- c("decrease", "decrease", "decrease", "decrease", "decrease", 
...
Optimal_Temp <- c(0.415, 0.359, 0.297, 0.818, 0.388, 
              ...
              0.295, 0.233, 
              0.406)
temp_arrows <- c("decrease", "increase", "decrease", "decrease", "increase", 
...
Length <- c(0.094, 0.828, 0.691, 0.964, 0.493, 
              ...
              0.928, 0.999, 
              0.799)
length_arrows <- c("decrease", "decrease", "increase", "increase", "increase", 
              "decrease", "increase", "increase", "increase", 
              "increase", "increase", "increase", 
              "decrease", "increase", 
              "increase")
...
Growth_Rate <- c(1, 1,1 , 1,0.969 , 
              ...
              0.999,0.996 , 
             1 )
growth_arrows <- c("increase", "increase", "decrease", "decrease", "decrease", 
...
ggsave(plot, file = paste0("figS7.pdf"), path = here::here("04_figs", "final_figs"), height = 12, width = 20)
```