...
r_fin_plot <- box_data(x = "r_fin", y = "class2") + 
  stat_kruskal_test(label.y = 1, label.x = 6, position = "jitter") +
  labs(y = "Growth Rate", x = "") +
  theme(axis.text.y = element_blank()) +
  scale_x_discrete(position = "top")
oxygen_plot <- box_data(x = "oxygen_cons", y = "class2") + 
  stat_kruskal_test(label.y = 2000, label.x = 6, position = "jitter") +
...
fecund_plot <- box_data(x = "fecundity_mean", y = "class2") + 
  stat_kruskal_test(label.y = 1000000, label.x = 5.5, position = "jitter") +
  labs(y = "Fecundity", x = "") +
  scale_x_discrete(position = "top")
