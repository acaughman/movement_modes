...
gmm_panel
#ggsave(gmm_panel, file = paste0("gmm_panel.png"), path = here::here("04_figs"), height = 10, width = 15)
...
temp_plot <- box_data(x = "temp_preferred", y = "class2") +
  labs(y = "Preferred Temperature", x = "")
...
tll_panel
#ggsave(tll_panel, file = paste0("tll_panel.png"), path = here::here("04_figs"), height = 12, width = 6)
