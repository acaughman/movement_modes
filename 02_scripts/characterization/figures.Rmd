...
p1 <- ggplot(fishbase_data_gmm, aes(magnitude_homerange, month_pld)) +
  geom_jitter() +
...
# panel
gmm_panel <- (p1 | gmm_new_fig) + 
  plot_annotation(tag_levels = 'A')

gmm_panel
#ggsave(gmm_panel, file = paste0("gmm_panel.png"), path = here::here("04_figs"), height = 6, width = 18)
...
tll_panel
#ggsave(tll_panel, file = paste0("tll_panel.png"), path = here::here("04_figs"), height = 17, width = 11)
