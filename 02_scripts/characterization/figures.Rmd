...
g <- ggplot(data1, aes(x = variable, y = cohort, fill = direction)) +
  ...
  geom_point(data = data1 %>% filter(significant == "yes"), shape = 8, size = 2, color = "white", show.legend = FALSE) +
...
ggsave(g, file = paste0("stats_sum2.png"), path = here::here("04_figs"), height = 12, width = 12)
