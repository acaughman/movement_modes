...
cohort <- c("Cohort 1 vs 2", "Cohort 1 vs 3", "Cohort 1 vs 4", "Cohort 1 vs 5", "Cohort 1 vs 6",
            "Cohort 2 vs 3", "Cohort 2 vs 4", "Cohort 2 vs 5", "Cohort 2 vs 6",
            "Cohort 3 vs 4", "Cohort 3 vs 5", "Cohort 3 vs 6",
            "Cohort 4 vs 5", "Cohort 4 vs 6",
            "Cohort 5 vs 6")
...
Optimal_Temp <- c(0.005043306637114, 0.000000051454126, 0.000113116310469, 0.789451442990800, 0.010082693281337,
                  ...
                  0.010090438574951)
temp_arrows <- c("higher", "higher", "higher", "equal", "lower",
...
Length <- c(0.8592642, 0.9998089, 0.9872521, 0.0007795, 0.0000000,
            ...
            0.9897718, 0.0008647,
            0.0000000)
length_arrows <- c("lower", "lower", "lower", "lower", "lower",
...
Lifespan <- c(0.57035468549, 0.00007769083, 0.55052882501, 0.74567296422, 0.31579160719,
              ...
              0.24664224315)
life_arrows <- c("lower", "lower", "lower", "equal", "higher",
...
Trophic_Level <- c(0.1035871996367, 0.0891868417293, 0.5697644317228, 0.5148291779984, 0.0000607828670,
                   ...
                   0.0000032514102)
trophic_arrows <- c("higher", "higher", "higher", "higher", "lower",
...
data1$variable <- factor(data1$variable, levels = c("PERMDISP", "PERMANOVA", "Optimal_Temp", "Length", "Lifespan", "Trophic_Level"))
data1$variable <- recode_factor(data1$variable, PERMDISP = "PERMDISP", PERMANOVA = "PERMANOVA", Optimal_Temp = "Optimal Temperature", Length = "Length", Lifespan = "Lifespan", Trophic_Level = "Trophic Level")



# Plot 
g <- ggplot(data1, aes(x = variable, y = cohort, label = p_value("%0.2f", round(a, digits = 4)), fill = significant)) +
