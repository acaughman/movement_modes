...
fishbase_data_gmm <- fishbase_data %>% 
...
missing <- miss_var_summary(data) # summary of missing data in each variable

missing_fig <- gg_miss_var(data) + # figure showing the missing data
  theme_bw()
missing_fig
