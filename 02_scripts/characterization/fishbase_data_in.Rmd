...
clusters <- read_csv(here::here("01_data", "02_processed_data", "clusters.csv")) %>%
  mutate(class2 = class) %>%
  mutate(class2 = case_when(class2 == 6 ~ 2,
                            class2 != 6 ~ class2
                            )) # combine classes 6 into 2
...
clusters <- clusters %>% 
  mutate(class2 = case_when(class2 == 1 ~ "mid-high/mid",
                            class2 == 2 ~ "high/mid",
                            class2 == 3 ~ "mid/mid-high",
                            class2 == 4 ~ "mid/low",
                            class2 == 5 ~ "mid/high",
                            class2 == 7 ~ "low/mid",
                            class2 == 8 ~ "mid-low/mid",
                            ))
