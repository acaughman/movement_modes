...
clusters <- clusters %>% 
  mutate(class3 = class2,
         class2 = case_when(class2 == 1 ~ "mid-high/mid-low",
                            class2 == 2 ~ "high/mid-low",
                            class2 == 3 ~ "mid/mid-high",
                            class2 == 4 ~ "mid/low",
                            class2 == 5 ~ "mid/high",
                            class2 == 7 ~ "low/mid-low",
                            class2 == 8 ~ "mid-low/mid-low"
                            ))
```
...
model  <- lm(class3 ~ demers_pelag, data = filled_data2)
# Create a QQ plot of residuals
ggqqplot(residuals(model))
# not normal

# run Kruskal-wallis test
kruskal.test(class3 ~ demers_pelag, data = filled_data2)
