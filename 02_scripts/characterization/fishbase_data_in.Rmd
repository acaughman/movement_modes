...
```{r}
######## ADD SORT TO UNIQUE IN ORDER TO ALPHABETISE THEM; DO THIS FOR ANYWHERE YOU USE UNIQUE
...
missing <- data %>% 
  select(oxygen_cons, temp_range, fecundity_max, 
         longevity_wild, temp_preferred, food_i, spawning, spawning_ground, dev_place, rep_guild2, iucn_category)
...
### ADD OXYGEN AND TEMP RANGE HERE AND SEE HOW MANY YOU GET 
