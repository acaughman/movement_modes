...
```{r}
model <- lm(
  class3 ~ temp_preferred + fecundity_mean +
...
f4_fig <- fviz_famd_ind(f4, label = "none", habillage = famd_filled4$class2, addEllipses = TRUE, ellipse.level = 0.55, invisible = "quali.var") +
  theme_bw()
