...
##### NMDS 7: Optimal temperature, length, longevity, trophic level
...
nmds7 <- ggplot(filled_scores7, aes(x = NMDS1, y = NMDS2)) +
  ...
  ggrepel::geom_label_repel(data = species_scores7, aes(x = MDS1, y = MDS2, label = var), fill = "white", cex = 3, direction = "both", segment.size = .25) +
  scale_y_continuous(position = "right") +
  theme(legend.position = "left", panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
...
#ggsave(nmds7, file = paste0("mnds_big_4_traits.pdf"), path = here::here("04_figs", "final_figs"), height = 8, width = 12)
