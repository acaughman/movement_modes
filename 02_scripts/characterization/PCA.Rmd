...
```{r}
model <- lm(
  class2 ~ temp_preferred + fecundity_mean +
...
fviz_contrib(f1, "var", axes = 1)
# Contribution to the second dimension
fviz_contrib(f1, "var", axes = 2)
...
f1_fig <- fviz_famd_ind(f1, habillage = famd_filled$class2, addEllipses = TRUE, ellipse.level = 0.95, invisible = "quali.var", label = "none") +
  theme_bw()
...
# Contribution to the first dimension
fviz_contrib(f2, "var", axes = 1)
# Contribution to the second dimension
fviz_contrib(f2, "var", axes = 2)
...
# Contribution to the first dimension
fviz_contrib(f3, "var", axes = 1)
# Contribution to the second dimension
fviz_contrib(f3, "var", axes = 2)
...
# Contribution to the first dimension
fviz_contrib(f4, "var", axes = 1)
# Contribution to the second dimension
fviz_contrib(f4, "var", axes = 2)
