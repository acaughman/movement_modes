...
```{r}
temp_plot <- box_data(x = "temp_preferred", y = "class2") + labs(y = "Preferred Temperature", x = "Movement Class")
...
temp_plot / long_plot / length_plot + plot_layout(guides = "collect") + plot_annotation(tag_levels = 'A')
```
