...
nmds4 <- ggplot(filled_scores4, aes(x = NMDS1, y = NMDS2)) +
  ...
  labs(x = "NMDS1", y = "NMDS2", color = "Cohort (Homerange/PLD)") +
  scale_color_viridis_d() +
  scale_fill_viridis_d() +
  geom_segment(data = species_scores, aes(x = 0, xend = MDS1, y = 0, yend = MDS2), arrow = arrow(length = unit(0.25, "cm")), linewidth = 0.8, colour = "grey20", lwd = 0.3) +
...
#ggsave(nmds4, file = paste0("nmds4.pdf"), path = here::here("04_figs", "final_figs"), height = 8, width = 12)
...
adonis2(com_data7$class2 ~ m_com7, permutations = 9999)
