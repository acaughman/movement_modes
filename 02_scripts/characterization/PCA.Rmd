...
kfin_plot <- box_data(x = "kfin", y = "class2") + stat_anova_test(label.y = 10000000, position = "jitter")
r_fin_plot <- box_data(x = "r_fin", y = "class2") + stat_anova_test(label.y = 1, position = "jitter")
