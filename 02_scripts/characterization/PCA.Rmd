...
model <- lm(class2 ~ temp_preferred + fecundity_mean + #fecundity_max +  
            longevity_wild + sp_richness + length + kfin + r_fin + diet_troph3, 
            data = filled_data)
...
com_data <- filled_data %>% 
   dplyr::select(temp_preferred, fecundity_mean, #fecundity_max, longevity_wild, 
...
com_data2 <- filled_data %>% 
   dplyr::select(temp_preferred, #fecundity_mean, #fecundity_max, 
          longevity_wild, 
          #sp_richness, 
