...
f1 <- FAMD(famd_filled[, 1:16], graph = FALSE)
f1
...
famd_filled2 <- filled_data2 %>%
  dplyr::select(
    ...
    dev_place, iucn_category, demers_pelag, class2
...
f2 <- FAMD(famd_filled2[, 1:11], graph = FALSE)
f2
...
f3 <- FAMD(famd_filled3[, 1:9], graph = FALSE)
f3
...
famd_filled4 <- filled_data2 %>%
  dplyr::select(
    temp_preferred, longevity_wild, sp_richness, length, 
    kfin, r_fin, diet_troph3, demers_pelag, class2
    # fecundity_mean, length, r_fin, diet_troph3,
    # oxygen_cons,
    # # temp_range,
    # climate,
...
sub4 = famd_filled4[,1:8]

f4 <- FAMD(sub4, graph = FALSE)
f4
...
#ggsave(plot4, file = paste0("f4.png"), path = here::here("04_figs", "famd_with_arrows"), height = 12, width = 15)
```

```{r}
# famd_filled5 <- filled_data2 %>%
#   dplyr::select(
#     temp_preferred, longevity_wild, length, 
#     diet_troph3, demers_pelag, class2
#     # fecundity_mean, length, r_fin, diet_troph3,
#     # oxygen_cons,
#     # # temp_range,
#     # climate,
...
#   na.omit()
# 
# f5 <- FAMD(famd_filled5[,1:5], graph = FALSE)
# f5
# 
# eigen_f5 <- f5$eig
# eigen_f5
...
# 
# 
# f5_fig <- fviz_famd_ind(f5, label = "none", habillage = famd_filled5$class2, addEllipses = TRUE, ellipse.level = 0.95, invisible = "quali.var") +
#   theme_bw()
# 
# f5_fig # 2 and 3 completely separate, 2 and 5 as well
# 
# plot5 <- p5 + f5_fig
# 
# plot5
...
#ggsave(nmds_plot1, file = paste0("nmds_plot1.png"), path = here::here("04_figs", "nmds"), height = 12, width = 12)
```
...
#ggsave(nmds_plot2, file = paste0("nmds_plot2.png"), path = here::here("04_figs", "nmds"), height = 12, width = 12)
```
...
#ggsave(nmds_plot3, file = paste0("nmds_plot3.png"), path = here::here("04_figs", "nmds"), height = 12, width = 12)
```
...
#ggsave(nmds_plot4, file = paste0("nmds_plot4.png"), path = here::here("04_figs", "nmds"), height = 12, width = 12)
```
...
#ggsave(nmds_plot5, file = paste0("nmds_plot5.png"), path = here::here("04_figs", "nmds"), height = 12, width = 12)
```
...
#ggsave(nmds_plot6, file = paste0("nmds_plot6.png"), path = here::here("04_figs", "nmds"), height = 12, width = 12)
```
