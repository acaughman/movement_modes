...
expl_cat_filled = c("dev_place", "food_i", "food_mode")
...
food_fill_plot <- scatter_filled(x = "food_mode", y = "class2")
...
f1_fig <- fviz_famd_ind(f1, habillage = famd_filled$class2, addEllipses = TRUE, ellipse.level = 0.95) +
  theme_bw()
