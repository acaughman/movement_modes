...
plots_cont <- map(expl_cont, ~ box_data(.x, "class3"))
plots_cont
```

```{r}
temp_plot <- box_data(x = "temp_preferred", y = "class3")
fecund_plot <- box_data(x = "fecundity_mean", y = "class3")
long_plot <- box_data(x = "longevity_wild", y = "class3")
sp_rich_plot <- box_data(x = "sp_richness", y = "class3")
length_plot <- box_data(x = "length", y = "class3")
kfin_plot <- box_data(x = "kfin", y = "class3")
r_fin_plot <- box_data(x = "r_fin", y = "class3")
diet_plot <- box_data(x = "diet_troph3", y = "class3")
oxygen_plot <- box_data(x = "oxygen_cons", y = "class3")
temp_range_plot <- box_data(x = "temp_range", y = "class3")
...
plots_cat <- map(expl_cat, ~ scatter_data(.x, "class3"))
plots_cat
```

```{r}
climate_plot <- scatter_data(x = "climate", y = "class3")
body_plot <- scatter_data(x = "body_shape_i", y = "class3")
dev_plot <- scatter_data(x = "dev_place", y = "class3")
demers_plot <- scatter_data(x = "demers_pelag", y = "class3")
iucn_plot <- scatter_data(x = "iucn_category", y = "class3")
food_plot <- scatter_data(x = "food_mode", y = "class3")
circ_plot <- scatter_data(x = "circadian", y = "class3")
ocean_plot <- scatter_data(x = "ocean", y = "class3")
basin_plot <- scatter_data(x = "basin", y = "class3")
