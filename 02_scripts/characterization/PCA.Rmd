...
nmds_arrows7 <- ggplot(filled_scores7, aes(x = NMDS1, y = NMDS2)) +
  geom_point(alpha = 0) +
  theme_bw() +
  labs(x = "NMDS1", y = "NMDS2") +
  theme(legend.position = "none") +
...
nmds7 <- nmds_arrows7 + nmds_plot7 & theme_bw(base_size = 16)

nmds7

#ggsave(nmds7, file = paste0("nmds_dispersion.png"), path = here::here("04_figs"), height = 8, width = 18)
