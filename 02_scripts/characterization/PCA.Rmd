...
ggsave(temp_plot, file = paste0("temp_plot.png"), path = here::here("04_figs", "individual_plots"))
ggsave(fecund_plot, file = paste0("fecund_plot.png"), path = here::here("04_figs", "individual_plots"))
ggsave(long_plot, file = paste0("long_plot.png"), path = here::here("04_figs", "individual_plots"))
ggsave(sp_rich_plot, file = paste0("sp_rich_plot.png"), path = here::here("04_figs", "individual_plots"))
ggsave(length_plot, file = paste0("length_plot.png"), path = here::here("04_figs", "individual_plots"))
ggsave(kfin_plot, file = paste0("kfin_plot.png"), path = here::here("04_figs", "individual_plots"))
ggsave(r_fin_plot, file = paste0("r_fin_plot.png"), path = here::here("04_figs", "individual_plots"))
ggsave(diet_plot, file = paste0("diet_plot.png"), path = here::here("04_figs", "individual_plots"))
