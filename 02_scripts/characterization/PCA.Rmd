...
response = "class2"
expl_cont = c("temp_preferred", "fecundity_mean",
...
ggsave(temp_plot, file = paste0("temp_plot.png"), path = here::here("04_figs", "individual_plots", "unfilled_data", "numeric"))
ggsave(fecund_plot, file = paste0("fecund_plot.png"), path = here::here("04_figs", "individual_plots", "unfilled_data", "numeric"))
ggsave(long_plot, file = paste0("long_plot.png"), path = here::here("04_figs", "individual_plots", "unfilled_data", "numeric"))
ggsave(sp_rich_plot, file = paste0("sp_rich_plot.png"), path = here::here("04_figs", "individual_plots", "unfilled_data", "numeric"))
ggsave(length_plot, file = paste0("length_plot.png"), path = here::here("04_figs", "individual_plots", "unfilled_data", "numeric"))
ggsave(kfin_plot, file = paste0("kfin_plot.png"), path = here::here("04_figs", "individual_plots", "unfilled_data", "numeric"))
ggsave(r_fin_plot, file = paste0("r_fin_plot.png"), path = here::here("04_figs", "individual_plots", "unfilled_data", "numeric"))
ggsave(diet_plot, file = paste0("diet_plot.png"), path = here::here("04_figs", "individual_plots", "unfilled_data", "numeric"))
...
expl_cat = c("climate", "body_shape_i", "dev_place", "movement_keyword", 
             "demers_pelag", "iucn_category", "food_i", "circadian")
...
move_keyword_plot <- scatter_data(x = "movement_keyword", y = "class2")
demers_plot <- scatter_data(x = "demers_pelag", y = "class2")
iucn_plot <- scatter_data(x = "iucn_category", y = "class2")
food_plot <- scatter_data(x = "food_i", y = "class2")
circ_plot <- scatter_data(x = "circadian", y = "class2")


ggsave(climate_plot, file = paste0("climate_plot.png"), path = here::here("04_figs", "individual_plots", "unfilled_data", "categorical"))
ggsave(body_plot, file = paste0("body_plot.png"), path = here::here("04_figs", "individual_plots", "unfilled_data", "categorical"))
ggsave(dev_plot, file = paste0("dev_plot.png"), path = here::here("04_figs", "individual_plots", "unfilled_data", "categorical"))
ggsave(move_keyword_plot, file = paste0("move_keyword_plot.png"), path = here::here("04_figs", "individual_plots", "unfilled_data", "categorical"))
ggsave(demers_plot, file = paste0("demers_plot.png"), path = here::here("04_figs", "individual_plots", "unfilled_data", "categorical"))
ggsave(iucn_plot, file = paste0("iucn_plot.png"), path = here::here("04_figs", "individual_plots", "unfilled_data", "categorical"))
ggsave(food_plot, file = paste0("food_plot.png"), path = here::here("04_figs", "individual_plots", "unfilled_data", "categorical"))
ggsave(circ_plot, file = paste0("circ_plot.png"), path = here::here("04_figs", "individual_plots", "unfilled_data", "categorical"))
...
expl_cont_filled = c("temp_preferred",  "fecundity_mean",
         "longevity_wild", "oxygen_cons", "temp_range")

box_filled = function(x, y) {
...
plots_cont_filled = map(expl_cont_filled, ~box_filled(.x, "class2"))
plots_cont_filled
...
temp_fill_plot <- box_filled(x = "temp_preferred", y = "class2")
fecund_fill_plot <- box_filled(x = "fecundity_mean", y = "class2")
long_fill_plot <- box_filled(x = "longevity_wild", y = "class2")
oxygen_plot <- box_filled(x = "oxygen_cons", y = "class2")
temp_range_plot <- box_filled(x = "temp_range", y = "class2")


ggsave(temp_fill_plot, file = paste0("temp_fill_plot.png"), path = here::here("04_figs", "individual_plots", "filled_data", "numeric"))
ggsave(fecund_fill_plot, file = paste0("fecund_fill_plot.png"), path = here::here("04_figs", "individual_plots", "filled_data", "numeric"))
ggsave(long_fill_plot, file = paste0("long_fill_plot.png"), path = here::here("04_figs", "individual_plots", "filled_data", "numeric"))
ggsave(oxygen_plot, file = paste0("oxygen_plot.png"), path = here::here("04_figs", "individual_plots", "filled_data", "numeric"))
ggsave(temp_range_plot, file = paste0("temp_range_plot.png"), path = here::here("04_figs", "individual_plots", "filled_data", "numeric"))
...
expl_cat_filled = c("dev_place", "food_i")
...
dev_fill_plot <- scatter_filled(x = "dev_place", y = "class2")
food_fill_plot <- scatter_filled(x = "food_i", y = "class2")


ggsave(dev_fill_plot, file = paste0("dev_fill_plot.png"), path = here::here("04_figs", "individual_plots", "filled_data", "categorical"))
ggsave(food_fill_plot, file = paste0("food_fill_plot.png"), path = here::here("04_figs", "individual_plots", "filled_data", "categorical"))
...
model <- lm(class2 ~ temp_preferred + fecundity_mean +  
...
# getting error when I include demers_pelag:
...
famd_filled <- filled_data %>% 
   dplyr::select(temp_preferred, fecundity_mean, #longevity_wild, 
          sp_richness, length, kfin, r_fin, diet_troph3, climate, body_shape_i, dev_place, 
          movement_keyword, #demers_pelag, 
          iucn_category, 
          food_i, class2) %>% 
   mutate(class2 = as.factor(class2)) %>% 
   na.omit()
...
f1 <- FAMD(famd_filled[,1:13], graph=FALSE)
f1
...
famd_filled2 <- filled_data %>% 
   dplyr::select(fecundity_mean, length, r_fin, diet_troph3, 
          #climate, 
          body_shape_i, 
          dev_place, 
          movement_keyword, 
...
com_data2 <- filled_data %>% 
   dplyr::select(temp_preferred, #fecundity_mean, 
          longevity_wild, 
          #sp_richness, 
