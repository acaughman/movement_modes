...
length_plot <- box_data(x = "length", y = "class2") + stat_kruskal_test(label.y = 5, position = "jitter")
kfin_plot <- box_data(x = "kfin", y = "class2") + stat_kruskal_test(label.y = 5, position = "jitter")
r_fin_plot <- box_data(x = "r_fin", y = "class2") + stat_kruskal_test(label.y = 5, position = "jitter")
diet_plot <- box_data(x = "diet_troph3", y = "class2") + stat_kruskal_test(label.y = 5, position = "jitter")
oxygen_plot <- box_data(x = "oxygen_cons", y = "class2") + stat_kruskal_test(label.y = 5, position = "jitter")
temp_range_plot <- box_data(x = "temp_range", y = "class2") + stat_kruskal_test(label.y = 5, position = "jitter")
