...
```{r}
temp_plot <- box_data(x = "temp_preferred", y = "class2") + stat_kruskal_test(label.y = 1, label.x = 6, position = "jitter") +
  labs(y = "Preferred Temperature", x = "Movement Class")
...
long_plot <- box_data(x = "longevity_wild", y = "class2") + stat_kruskal_test(label.y = 100, position = "jitter") +
  labs(y = "Longevity", x = "Movement Class")
...
length_plot <- box_data(x = "length", y = "class2") + stat_anova_test(label.y = 400, position = "jitter") +
