...
```{r}
lm1 = lm(home_range ~ length*diet_troph3*longevity_wild*temp_preferred, data = filled_data2)
lm2 = lm(pld ~ length*diet_troph3*longevity_wild*temp_preferred, data = filled_data2)
stepAIC(lm1)
stepAIC(lm2)

lm1.1 = lm(home_range ~ length + diet_troph3 + longevity_wild + 
    temp_preferred + length:diet_troph3 + length:longevity_wild + 
    length:temp_preferred + diet_troph3:temp_preferred + longevity_wild:temp_preferred + 
...
lm2.1 = lm(pld ~ length + diet_troph3 + longevity_wild + temp_preferred + 
    ...
    longevity_wild:temp_preferred + length:longevity_wild:temp_preferred, data = filled_data2)
...
plot_model(lm1.1, type = "int")
plot_model(lm2.1, type = "int")
```
