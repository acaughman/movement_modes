...
p1 <- plot_comparisons(lm1.1, variables = "length", condition = c("temp_preferred", "diet_troph3"), comparison = "difference") +
  labs(
    x = "Length",
    y = "Home Range Difference with Optimal Temperature",
    color = "Trophic Level",
    fill = "Trophic Level"
  ) +
  theme_bw() +
...
p2 <- plot_comparisons(lm1.1, variables = "length", condition = c("temp_preferred", "longevity_wild")) +
  labs(
    x = "Length",
    y = "Home Range Difference with Optimal Temperature",
    color = "Longevity",
...
p3 <- plot_comparisons(lm1.1, variables = "length", condition = c("longevity_wild", "diet_troph3"), comparison = "difference") +
  labs(
    x = "Length",
    y = "Home Range Difference with Longevity",
    color = "Trophic Level",
    fill = "Trophic Level"
  ) +
  theme_bw() +
...
p4 <- plot_comparisons(lm2.1, variables = "length", condition = c("temp_preferred", "longevity_wild")) +
  labs(
    x = "Length",
...
ggsave(interact_plot, file = paste0("interact_plot.pdf"), path = here::here("04_figs"), height = 8, width = 10)
```
