...
p2 <- plot_comparisons(lm1.1, variables = "temp_preferred", condition = c("length", "longevity_wild")) +
  labs(
    x = "Optimal Temperature",
    y = "Home Range Difference with Length",
    color = "Longevity",
...
p4 <- plot_comparisons(lm2.1, variables = "temp_preferred", condition = c("length", "longevity_wild")) +
  labs(
    x = "Optimal Temperature",
