...
### ANOVA/Kruskal-Wallis/Chi-Squared --- ADD EFFECT SIZES FOR ANOVAS ----------------------------------
...
# contingency table
dev_table <- table(filled_data2$class2, filled_data2$dev_place)
dev_table
...
# contingency table
food_table <- table(filled_data2$class2, filled_data2$food_mode)
food_table

# post-hoc test
chisq.posthoc.test(food_table, method = "bonferroni")
