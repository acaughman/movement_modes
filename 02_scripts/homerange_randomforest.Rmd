...
write_csv(prediction, here::here("data", "homerange_rf_predictions.csv"))
```
...
varimp <- ggplot(var_imp, aes(x = dropout_loss, y = variable)) + # plot variable importance
  ...
  scale_y_discrete(name = "", labels = c("Baseline", "Geographic Range", "Length", "Carrying Capacity", "Trophic Level", "Movement Keyword", "Full Model", "Growth Rate")) + theme(text = element_text(size = 10))  
```
